...
function ImageIdentificationGame() {
    ...
    const [gamePhase, setGamePhase] = useState('loading'); // loading ->review -> select -> result -> done
    ...
    return (
        <div className="App">
            ...
            {(gamePhase === 'select') && <h1>Is this image new or old?</h1>}
            {(gamePhase === 'review' || gamePhase === 'select') && (
